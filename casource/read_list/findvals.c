/*RCS Id:$Id: findvals.c 887 2006-03-01 18:21:01Z rcatwood $*/
#include <stdio.h>
#include <string.h>
#include "../machine.h"
#include "../constants.h"
...
fg->Tmin = 10000;
i=0;
       for(zz=0;zz<fg->nz;zz++){
    for (rr=0;rr<fg->nr;rr++){
       fg->Fidap_T[zz*fg->nr + rr] = the_float->data[i][tfield];
...
RCS Log:
RCS Log:Revision 1.1.2.4  2003/02/25 19:43:58  kerman
